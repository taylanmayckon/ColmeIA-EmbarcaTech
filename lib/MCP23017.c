...
void MCP23017_init(MCP23017 *expander){
    ...
    write_register(expander->address, MCP_INTCONA, 0x00); // habilita a comparação com o registrador "DEF_VAL"
    ...
    write_register(expander->address, MCP_INTCONB, 0x00); // habilita a comparação com o registrador "DEF_VAL"
